class SectionsController < ApplicationController
  ...
  private
    ...
    def section_params
      params.require(:section).permit(:part, :workout_id)
      params.require(:section).permit(:name, section_exercises_attributes: [:id, :exercise_id, :rounds, :reps, :weight, :_destroy])
