...
class CoachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coach" do
    assert_difference("Coach.count") do
      post coaches_url, params: { coach: { authorized: @coach.authorized, name: @coach.name, phone_number: @coach.phone_number, tenant_id: @coach.tenant_id } }
    end
  ...
  test "should update coach" do
    patch coach_url(@coach), params: { coach: { authorized: @coach.authorized, name: @coach.name, phone_number: @coach.phone_number, tenant_id: @coach.tenant_id } }
