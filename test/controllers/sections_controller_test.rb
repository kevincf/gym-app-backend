...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference("Section.count") do
      post sections_url, params: { section: { part: @section.part, workout_id: @section.workout_id } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { part: @section.part, workout_id: @section.workout_id } }
